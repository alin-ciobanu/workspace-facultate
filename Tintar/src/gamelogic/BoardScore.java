...
public class BoardScore {
	...
	private boolean checkMorisca (PLAYER play_as) {
		...
		TreeSet<Pair<Integer, Integer>> points = b.getAllPointsOfBoard();
	...
	public boolean checkLineCompleted (Pair<Integer, Integer> pos, PLAYER player) {

		if (player == PLAYER.BLACK) {
			return checkLineCompleted(pos, MARK.BLACK);
		} else {
			return checkLineCompleted(pos, MARK.WHITE);
		}
	 ...
	 */
	public boolean checkLineCompleted (Pair<Integer, Integer> pos, MARK mark) {
	...
	public static void main(String[] args) {
		...
		b.putPiece(new Pair<Integer, Integer>(4, 6), MARK.BLACK);

		b.putPiece(new Pair<Integer, Integer>(3, 3), MARK.WHITE);
		b.putPiece(new Pair<Integer, Integer>(6, 3), MARK.WHITE);

		System.out.println(b);

		BoardScore sc = new BoardScore(b);
		System.out.println(sc.checkLineCompleted(new Pair<Integer, Integer>(4, 6), PLAYER.BLACK));
